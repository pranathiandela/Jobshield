        ...
        if not f or not f.filename:
            ...
            if ext not in {".pdf",".doc",".docx"}:
                ...
                result = {
                    ...
                    "signals":[
                        "File type accepted.",
                        "Resume is stored in the local project uploads folder.",
                        "No external exposure database is queried by this starter version."
                    ]
                }
...
def login():
    ...
    return render_template("login.html", title="Get Started", active="")
